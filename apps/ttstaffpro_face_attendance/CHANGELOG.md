...
- Added comprehensive iOS privacy usage descriptions (`NSCameraUsageDescription`, `NSMicrophoneUsageDescription`, `NSPhotoLibraryUsageDescription`, `NSLocationWhenInUseUsageDescription`, `NSLocationAlwaysUsageDescription`, `NSMotionUsageDescription`, `NSAppleMusicUsageDescription`, `NSSpeechRecognitionUsageDescription`, `UIBackgroundModes`) and `ITSAppUsesNonExemptEncryption` compliance to `Info.plist`. Bumped build number to 32.
