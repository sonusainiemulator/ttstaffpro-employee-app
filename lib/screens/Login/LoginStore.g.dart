...
mixin _$LoginStore on LoginStoreBase, Store {
  ...
  late final _$isDemoRegisterBtnLoadingAtom =
      Atom(name: 'LoginStoreBase.isDemoRegisterBtnLoading', context: context);

  @override
  bool get isDemoRegisterBtnLoading {
    _$isDemoRegisterBtnLoadingAtom.reportRead();
    return super.isDemoRegisterBtnLoading;
  }

  @override
  set isDemoRegisterBtnLoading(bool value) {
    _$isDemoRegisterBtnLoadingAtom
        .reportWrite(value, super.isDemoRegisterBtnLoading, () {
      super.isDemoRegisterBtnLoading = value;
    });
  }
  ...
  late final _$isLoginWithUidBtnLoadingAtom =
      Atom(name: 'LoginStoreBase.isLoginWithUidBtnLoading', context: context);

  @override
  bool get isLoginWithUidBtnLoading {
    _$isLoginWithUidBtnLoadingAtom.reportRead();
    return super.isLoginWithUidBtnLoading;
  }

  @override
  set isLoginWithUidBtnLoading(bool value) {
    _$isLoginWithUidBtnLoadingAtom
        .reportWrite(value, super.isLoginWithUidBtnLoading, () {
      super.isLoginWithUidBtnLoading = value;
    });
  }
  ...
  late final _$isDeviceVerifiedAtom =
      Atom(name: 'LoginStoreBase.isDeviceVerified', context: context);

  @override
  bool get isDeviceVerified {
    _$isDeviceVerifiedAtom.reportRead();
    return super.isDeviceVerified;
  }

  @override
  set isDeviceVerified(bool value) {
    _$isDeviceVerifiedAtom.reportWrite(value, super.isDeviceVerified, () {
      super.isDeviceVerified = value;
    });
  }
...
isDemoRegisterBtnLoading: ${isDemoRegisterBtnLoading},
isLoading: ${isLoading},
isLoginWithUidBtnLoading: ${isLoginWithUidBtnLoading},
